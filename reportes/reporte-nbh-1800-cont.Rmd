---
title: "Pruebas consulta popular - 1800 - contaminadas"
...
muestras <- read_csv("../muestras_csv/muestras_contaminadas_cp_2021_1800.csv")
```
...
```{r}
write_rds(resultados_tbl, "resultados-nbh-1-1800-cont.rds")
